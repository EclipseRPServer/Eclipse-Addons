...
AddEventHandler('onResourceStop', function(resource)
    if resource ~= GetCurrentResourceName() then return end
        exports['qb-target']:RemoveTargetModel(Config.atms, "View Bank Account")
        exports['qb-target']:RemoveTargetEntity(peds.basic, "View Bank Account")
        exports['qb-target']:RemoveTargetEntity(peds.adv, {"View Bank Account", "Manage Bank Account"})
    DeletePeds()
end)

local Translations = {
     ...
     mail = {
          ...
          message = 'Dear %s %s, List of materials you need to craft (%s): Success rate: %d, Restricted: %s ',
          level = ' Level: %s ',
          yes = 'Yes',
          no = 'No',
          tnx_message = ' We are happy to have you!',
          materials_list_header = ' Materials list:',
          materials_list = '- %s %dx'
     },
     menu = {
          back = 'Back',
